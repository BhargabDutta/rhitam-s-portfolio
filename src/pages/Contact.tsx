          ...
          >
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  href="tel:+918822184165" 
                  className="contact-button bg-accent-100 hover:bg-accent-200 text-white"
                >
                  <Phone size={18} />
                  Call Now
                </a>
                <a 
                  href="https://wa.me/918822184165" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="contact-button bg-[#25D366] hover:bg-[#128C7E] text-white"
                >
